...
const About = () => {
  return (
    <div className="container">
      <div className="card">
        <h4 className="card-header">About</h4>
        <div className="card-body">
          <h5 className="card-title">What is WordCounter?</h5>
          <p className="card-text">
            ...
            keyword density of the article you're writing. This allows you to
            know which keywords you use how often and at what percentages. This
            can prevent you from over-using certain words or word combinations
            and check for best distribution of keywords in your writing. In the
            Details overview you can see the average speaking and reading time
            for your text, while Reading Level is an indicator of the education
            level a person would need in order to understand the words you’re
            using. Disclaimer: We strive to make our tools as accurate as
            possible but we cannot guarantee it will always be so.
          </p>
